...
export default function LandingPage() {
  ...
  return (
    ...
    <div className="min-h-screen w-full bg-[#f2f7fb] text-slate-700 flex flex-col pt-20 pb-12 px-3 sm:px-6 font-sans">
      ...
      <div className="mx-auto w-full max-w-4xl rounded-2xl bg-white p-5 sm:p-8 md:p-12 shadow-[0_4px_25px_rgba(186,215,233,0.25)] border border-gray-100 flex flex-col gap-8 md:gap-12 text-left">

        {/* ================= HERO SECTION ================= */}
        <header className="flex flex-col items-start w-full">
          
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold tracking-tight text-[#212529] leading-tight max-w-2xl">
            Your medications shouldn't need <em className="italic font-normal text-yellow-600">four different apps</em> to manage.
          </h1>

          <div className="space-y-4 text-left mt-4 sm:mt-6 w-full">
            <div className="inline-flex flex-wrap items-center gap-1.5 sm:gap-2 md:gap-3 rounded-2xl sm:rounded-full border border-slate-200/80 bg-white/80 px-3 py-1.5 shadow-sm backdrop-blur-sm text-xs sm:text-sm">
              <span className="font-semibold text-[#1b4332]/60">Search medication</span>
              <span className="text-slate-400">→</span>
              <span className="font-semibold text-[#1b4332]/70">Build your list</span>
              <span className="text-slate-400">→</span>
              <span className="font-semibold text-[#1b4332]/90">Add personal notes</span>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-start mt-6 w-full sm:w-auto relative z-10">
            <button
              onClick={() => navigate("/search")}
              className="h-11 sm:h-10 px-6 rounded-lg bg-[#ffcb69] border border-[#dee2e6] text-sm font-semibold text-[#212529] transition-all shadow-sm hover:bg-[#ff9e00] active:scale-[0.98] cursor-pointer w-full sm:w-auto"
            >
            ...
            <a 
              ...
              className="relative z-10 h-11 sm:h-10 px-6 gap-2 inline-flex items-center justify-center rounded-lg bg-white border border-sky-200 text-sm font-semibold text-sky-800 transition-all shadow-sm hover:bg-sky-50 active:scale-[0.98] cursor-pointer select-none w-full sm:w-auto"
            >
              <svg 
                aria-hidden="true" 
                viewBox="0 0 24 24" 
          ...
          <div className="mt-3 text-xs font-medium tracking-wide text-slate-400">
            Free to use, no account required to search
          </div>

          {/* ANIMATED FRAGMENT VISUAL (Baby Blue Theme) */}
          <div className="relative h-[220px] sm:h-[260px] mt-8 w-full max-w-[560px] hidden sm:block self-center" aria-hidden="true">
            {/* Floating Card 1 */}
            ...
            {/* Final Target Card */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 scale-[0.94] w-[280px] sm:w-[300px] bg-white border border-sky-200 rounded-xl shadow-md p-4 sm:p-5 opacity-0 animate-[finalIn_1s_ease-out_1.35s_both]">
        ...
        {/* MOCKUP CONTAINER */}
        <div className="w-full max-w-4xl mx-auto -mt-0 sm:-mt-70">
          <div className="overflow-hidden rounded-xl border border-gray-200/80 bg-white shadow-xl shadow-sky-900/5 transition-all">
            <div className="flex items-center gap-2 border-b border-sky-100 bg-slate-50/80 px-3 sm:px-4 py-2 sm:py-2.5">
              ...
              <div className="ml-2 flex-1 rounded-md bg-white border border-slate-200/60 px-2.5 sm:px-3 py-0.5 text-[11px] sm:text-xs text-slate-400 font-mono text-center sm:text-left truncate">
        ...
        <section className="w-full">
          <div className="max-w-2xl mb-6">
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#212529] leading-snug">
            ...
            <div className="mt-4 sm:mt-6 flex flex-col gap-1.5 text-left">
              <span className='text-gray-400 text-xs sm:text-sm font-medium'>Standing at the counter:</span>
              <DynamicPrompt />
            </div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            <div className="rounded-lg border border-[#e9ecef] bg-[#f5f3f4] p-4 sm:p-5 transition-all hover:bg-white hover:shadow-sm">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[#9a8c98] flex items-center justify-center mb-3 shadow-sm">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 stroke-[#e9ecef]" viewBox="0 0 24 24" fill="none" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="7"/><path d="m21 21-4.3-4.3"/></svg>
              </div>
              <h4 className="text-sm font-semibold text-[#212529] mb-1">A good search tool</h4>
            ...
            <div className="rounded-lg border border-[#e9ecef] bg-[#f5f3f4] p-4 sm:p-5 transition-all hover:bg-white hover:shadow-sm">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[#9a8c98] flex items-center justify-center mb-3 shadow-sm">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 stroke-[#e9ecef]" viewBox="0 0 24 24" fill="none" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16v16H4z" /><path d="M8 9h8M8 13h5" /></svg>
              </div>
              <h4 className="text-sm font-semibold text-[#212529] mb-1">A good notes app</h4>
            ...
            <div className="rounded-lg border border-[#e9ecef] bg-[#f5f3f4] p-4 sm:p-5 transition-all hover:bg-white hover:shadow-sm sm:col-span-2 md:col-span-1">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-[#9a8c98] flex items-center justify-center mb-3 shadow-sm">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 stroke-[#e9ecef]" viewBox="0 0 24 24" fill="none" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>
              </div>
              <h4 className="text-sm font-semibold text-[#212529] mb-1">A good way to share it</h4>
          ...
          <div className="mt-4 sm:mt-6 p-3.5 sm:p-4 rounded-lg bg-amber-100/60 border border-amber-200/50">
        ...
        <section id="how" className="w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="rounded-lg border border-[#f8f9fa] bg-[#f8f9fa] p-4 sm:p-5 shadow-sm transition-all hover:border-gray-300 hover:shadow-md">
        ...
        {/* AI COMPARISON BOX */}
        <div className="w-full rounded-xl bg-[#fff0f3]/60 p-4 sm:p-6">
          <h3 className="text-base sm:text-lg font-bold text-[#212529] mb-1.5">Why not just ask an AI?</h3>
          <p className="text-xs sm:text-sm text-slate-600 leading-relaxed">Fair question, and a fast one. But it doesn't hold up for what this is actually for.</p>
          <ul className="list-none mt-3.5 sm:mt-4 flex flex-col gap-2 sm:gap-2.5">
            <li className="text-xs sm:text-sm text-slate-600 pl-4 relative before:content-['•'] before:absolute before:left-0 before:text-[#660708]">
        ...
        <section className="w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3.5 sm:gap-4">
            <div className="rounded-lg border border-sky-100 bg-white p-4 sm:p-5 border-l-4 border-l-[#8d99ae] shadow-sm">
          ...
          <div className="inline-flex items-center gap-2 border border-sky-200/60 bg-[#edf2f4] rounded-md px-3 py-1.5 text-xs text-slate-600 mt-5 sm:mt-6">
            <span className="text-[10px] bg-[#ffbc42] text-[#212529] px-1.5 py-0.5 rounded font-semibold shrink-0">NEXT UP</span>
            <span>Share a list with your family member or a caregiver.</span>
          </div>
        </section>
        ...
        {/* ================= ABOUT SECTION ================= */}
        <section id="about" className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center w-full">
          <div>
            ...
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#212529] leading-snug mb-3">
              Mark Cheng
              <br />
              <span className="text-slate-500 font-normal text-base sm:text-lg md:text-xl">
          ...
          <div className="grid grid-cols-1 gap-3 w-full">
            <div className="p-3.5 sm:p-4 bg-white rounded-xl border border-slate-100 shadow-sm flex items-start gap-3">
              <div className="p-2 bg-blue-50 text-blue-600 rounded-lg text-base sm:text-lg shrink-0">🏥</div>
              <div>
            ...
            <div className="p-3.5 sm:p-4 bg-white rounded-xl border border-slate-100 shadow-sm flex items-start gap-3">
              <div className="p-2 bg-indigo-50 text-indigo-600 rounded-lg text-base sm:text-lg shrink-0">⚡</div>
              <div>
            ...
            <div className="p-3.5 sm:p-4 bg-white rounded-xl border border-slate-100 shadow-sm flex items-start gap-3">
              <div className="p-2 bg-emerald-50 text-emerald-600 rounded-lg text-base sm:text-lg shrink-0">🚀</div>
              <div>
        ...
        {/* ================= FINAL CTA SECTION ================= */}
        <section className="rounded-xl border border-sky-100 bg-sky-50/60 p-5 sm:p-8 md:p-10 w-full text-left">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#212529]">
            No more switching tabs at the counter.
          </h2>
          <p className="text-slate-600 mt-2 mb-6 text-xs sm:text-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-start w-full sm:w-auto">
            <button
              onClick={() => navigate("/search")}
              className="h-11 sm:h-10 px-6 rounded-lg bg-[#8ac926]/50 border border-[#8ac926]/10 text-sm font-semibold text-[#343a40] transition-all shadow-sm hover:bg-[#f0ffce] hover:border-[#dee2e6] active:scale-[0.98] cursor-pointer w-full sm:w-auto text-center"
            >
              Start building your list
            </button>
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="h-11 sm:h-10 px-6 gap-2 inline-flex items-center justify-center rounded-lg bg-white border border-sky-200 text-sm font-semibold text-sky-800 transition-all shadow-sm hover:bg-sky-50 active:scale-[0.98] w-full sm:w-auto"
            >
              <svg 
                aria-hidden="true" 
                viewBox="0 0 24 24" 
      ...
      {/* FOOTER */}
      <footer className="pt-6 sm:pt-8 pb-4 text-left max-w-4xl mx-auto w-full px-2 text-slate-400 text-xs font-medium">
        myMedication {' '}
